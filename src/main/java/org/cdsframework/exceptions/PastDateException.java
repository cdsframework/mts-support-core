...
/**
 * Provides an exception for conveyance of a past date error context.
 *
 * @author HLN Consulting, LLC
 */
@ApplicationException(rollback = true)
public class PastDateException extends BaseExceptionRollback {
    ...
    public String getUserMessage() {
        return "The date that was provided was not a valid date.";
    }
}